...
def train3(cnn,EPOCH,train_loader,test_loader,LR):
...
# validation
def validation_test(cnn,alpha, k, max_count,batchsize,EPOCH,LR,dev_batchsize):
    ...
    for i in range(k):
        ...
        train3(cnn,EPOCH, train_loader, dev_loader, LR)
...
if __name__ == '__main__':
    ...
    # cross validation
    validation_test(cnn,alpha, k, max_count_rw,batchsize,EPOCH,LR,dev_batchsize=50)
